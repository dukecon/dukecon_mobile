...
import org.dukecon.domain.model.TargetHost
...
class LibrariesListRepository : LibrariesRepository {
    ...
    val libraries = listOf(
            ...
            Library("Kotlin", "JetBrains", "Apache 2", "http://kotlinlang.org/", TargetHost.COMMON),
            Library("Kotlin/Native", "JetBrains", "Apache 2", "http://kotlinlang.org/", TargetHost.COMMON),
            Library("Ktor", "JetBrains", "Apache 2", "https://ktor.io", TargetHost.COMMON),
