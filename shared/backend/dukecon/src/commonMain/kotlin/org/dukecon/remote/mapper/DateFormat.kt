...
// TODO duplicated code from domain, move it to "common" ?
...
fun GMTDate.toMillis(): Long {
    return this.timestamp
}

fun GMTDate.isAfter(date: GMTDate): Boolean {
    return this.timestamp > date.timestamp
}

fun GMTDate.isBefore(date: GMTDate): Boolean {
    return this.timestamp < date.timestamp
}
