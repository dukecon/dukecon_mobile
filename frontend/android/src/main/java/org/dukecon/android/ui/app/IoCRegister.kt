...
object IoCRegister {
    fun registerEventDetail(app: Application) {
        ...
        IoCProvider.registerType(ConferenceConfiguration::class,
    ...
    private fun createEventListPresenter(): EventListContract.Presenter {
        ...
        return EventListPresenter(currentTimeProvider, conferenceRepository, EventMapper(speakersMapper))
    }
    ...
    fun registerSpeakerDetail(dukeconApplication: DukeconApplication) {
        val conferenceRepository = IoCProvider.get<ConferenceRepository>()
        IoCProvider.registerType(SpeakerDetailContract.Presenter::class,
                SpeakerDetailPresenter(conferenceRepository,
                        SpeakerDetailMapper(TwitterLinks())))
    }
}
