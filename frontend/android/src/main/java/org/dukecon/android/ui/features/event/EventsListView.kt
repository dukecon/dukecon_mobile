...
constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) :
  ...
  private val presenter by lazy { IoCProvider.get<EventListContract.Presenter>() }
  private val sessionNavigator by lazy { IoCProvider.get<SessionNavigator>() }
  private val currentTimeProvider by lazy { IoCProvider.get<CurrentTimeProvider>() }
  ...
  init {
    ...
    adapter =
        EventsAdapter(currentTimeProvider) { session -> sessionNavigator.showSession(session) }
