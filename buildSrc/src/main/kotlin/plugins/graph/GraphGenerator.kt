...
internal class ProjectDependencyGraphGenerator(
        ...
        private val projectGenerator: DependencyGraphGeneratorExtension.ProjectGenerator = DependencyGraphGeneratorExtension.ProjectGenerator()
) {
    ...
    private fun addProjects(projects: MutableSet<Project>, rootProjects: MutableList<Project>, dependencies: MutableList<ProjectDependencyContainer>, graph: MutableGraph) {
        project.allprojects
    ...
    private fun rankRootProjects(graph: MutableGraph, projects: MutableSet<Project>, rootProjects: MutableList<Project>) {
